...
OUTPUT_DIR = fr"E:\Data\Reports_Collected\AI_Conclusion\R1\{PROMPT_NAME}\{BATCH_NAME}"
...
if __name__ == "__main__":
    ...
    all_files = gather_input_files(INPUT_DIR)[3500:MAX_FILES]
